...
arbuthnot <- arbuthnot %>% mutate(proportion_boys = boys / total)
arbuthnot <- arbuthnot %>% mutate(proportion_girls = girls / total)
ggplot(data = arbuthnot, aes(x = year, y = proportion_girls)) +
  geom_line() +
  geom_point()
```
