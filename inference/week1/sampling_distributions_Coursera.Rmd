...
ames %>%
  summarise(mu = mean(area),
            ...
            pop_q2 = quantile(area, 0.50),  # second quartile, 50th percentile
...
ggplot(data = price_sample, aes(x = x_bar)) +
...
ggplot(data = sample_means50, aes(x = price)) +
  geom_histogram(binwidth = 10000)
...
sample_means50 %>%
    summarise(mu = mean(price),
            ...
            pop_q2 = quantile(price, 0.50),  # second quartile, 50th percentile
            pop_q3 = quantile(price, 0.75))  # third quartile, 75th percentile

sample_means150 <- ames %>%
                    rep_sample_n(size = 150, reps = 25, replace = TRUE) %>%
                    summarise(price = mean(price))

ggplot(data = sample_means150, aes(x = price)) +
  geom_histogram(binwidth = 10000)
